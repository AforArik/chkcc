...
$sk = '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';
$lista = $_GET['lista'];
...
if(strpos($result3, '"seller_message": "Payment complete."' )) {
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $1 Charged ✅ | @AforArdi <br> ➤ Receipt : <a href='.$receipturl.'>Here</a><br>';
}
...
elseif(strpos($result2,'"code": "incorrect_cvc"')){
    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: Security code is incorrect by | @AforArdi </span><br>';
}
...
elseif(strpos($result2,'"cvc_check": "unchecked"')){
    echo '#DIE</span>  </span>CC:  '.$lista.'</span>  <br>Result: GENERIC DECLINE | @AforArdi </span><br>';
}
...
elseif(strpos($result1, "card_not_supported" )) {
    ...
    echo '#DIE</span> CC:  '.$lista.'</span>  <br>Result: GENERIC DECLINE | @AforArdi </span><br>';
